       ...
       <FlatList
        ...
        renderItem={({item}) => 
            ...
            <View style={{flex:1, flexDirection: 'row'}}>
              ...
              <Image source = {{ uri: "https://obaba.shop/admin/productimages/" + item.id + "/" + item.productImage1  }} style={styles.imageView} />
            
              <Text onPress={this.GetItem.bind(this, item.productName)} style={styles.textView} >{item.productName}</Text>
